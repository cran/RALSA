          ...
          tabItem(tabName = "prctls", class = "active",
                  ...
                  fluidRow(
                    ...
                    column(width = 1,
                           ...
                           tags$style(type='text/css', "#prctlsValuesReset {margin-top: 13px;}") # Align the reset button with the percentiles text input by padding it from the top.
                    ),
                    column(width = 4,
          ...
          tabItem(tabName = "bnchMarks", class = "active",
                  ...
                  fluidRow(
                    ...
                    column(width = 1,
                           ...
                           tags$style(type='text/css', "#benchValuesReset {margin-top: 13px;}") # Align the reset button with the percentiles text input by padding it from the top.
                    ),
                    column(width = 4,
