...
objDiv.scrollTop = objDiv.scrollHeight;
          ...
          tabItem(tabName = "corr", class = "active",
                  ...
                  fluidRow(
                    column(width = 3,
                           div(style = "margin-top: 40px",
                               uiOutput(outputId = "corrEffectiveDF"),
                               tags$head(tags$style("#corrEffectiveDF {white-space: nowrap;}"))
                           )
                    ),
                    column(width = 9,
                           div(style = "margin-top: 40px",
                               uiOutput(outputId = "corrComputations")
                           ),
...
objDiv.scrollTop = objDiv.scrollHeight;
          ...
          tabItem(tabName = "linReg", class = "active",
                  ...
                  fluidRow(
                    column(width = 3,
                           div(style = "margin-top: 40px",
                               uiOutput(outputId = "linRegEffectiveDF"),
                               tags$head(tags$style("#linRegEffectiveDF {white-space: nowrap;}"))
                           )
                    ),
                    column(width = 9,
                           div(style = "margin-top: 40px",
                               uiOutput(outputId = "linRegComputations")
                           ),
