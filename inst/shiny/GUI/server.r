server <- function(input, output, session) {
  ...
  all.studies.available.weights <- c("SCHWGT", "TOTWGT", "SENWGT", "TOTWGTCH", "SENWGTCH", "HOUSEWGT", "TOTWGTC", "TOTWGTS", "SENWGTS", "TOTWGTT", "SENWGTT", "SENWGTC", "STOTWGTU", "HOUWGT", "TCHWGT", "MTOTWGT", "STOTWGT", "CNTRWGT", "STAFFWGT", "INSWGTE", "FINWGTE", "INSWGTI", "FINWGTI", "INSWGTP", "FINWGTP", "INSWGTS", "FINWGTS", "MATWGT", "SCIWGT", "PHYWGT", "REAWGT", "WNRSCHBW", "SCWEIGHT", "W_FSCHWT", "SENWGT_SCQ", "W_SCHGRNRABWT", "W_SCHGRNRABWT", "SENWGT_PAQ", "W_FSTUWT")
  ...
  studies.all.design.variables <- list(
    ...
    sampling.vars = list(
      ...
      bc_ = c("SCHWGT", "STDWGT"), # CivED
      bl_ = c("TOTWGT", "SENWGT", "JKZONE", "JKREP", "TOTWGTCH", "SENWGTCH"), # CivED
      bs_ = c("TOTWGT", "SENWGT", "JKZONE", "JKREP"), # CivED

      isa = c("TOTWGTS", "JKZONES", "JKREPS", paste0("SRWGT", 1:75)), # ICCS
      icg = c("TOTWGTC", "JKZONEC", "JKREPC", paste0("CRWGT", 1:75)), # ICCS
      ise = c("TOTWGTS", "JKZONES", "JKREPS", paste0("SRWGT", 1:75)), # ICCS
      isg = c("TOTWGTS", "JKZONES", "JKREPS", paste0("SRWGT", 1:75)), # ICCS
      isl = c("TOTWGTS", "JKZONES", "JKREPS"), # ICCS
      iss = c("TOTWGTS", "JKZONES", "JKREPS"), # ICCS
      itg = c("TOTWGTT", "JKZONET", "JKREPT", paste0("TRWGT", 1:75)), # ICCS
      jsa = c("TOTWGTS", "JKZONES", "JKREPS", paste0("SRWGT", 1:75)), # ICCS
      jse = c("TOTWGTS", "JKZONES", "JKREPS", paste0("SRWGT", 1:75)), # ICCS
      jsg = c("TOTWGTS", "JKZONES", "JKREPS", paste0("SRWGT", 1:75)), # ICCS

      asa = c("TOTWGT", "HOUWGT", "SENWGT", "JKZONE", "JKREP", "JKINDIC"), # PIRLS, TiPi, TIMSS G4
      acg = c("SCHWGT", "STOTWGTU", "STOTWGTL", "JKCZONE", "JKCREP", paste0("SRWGT", 1:100)), # PIRLS, TiPi, TIMSS G4, TALIS
      asc = c("TOTWGT", "HOUWGT", "SENWGT", "JKZONE", "JKREP"), # RLII
      asg = c("TOTWGT", "HOUWGT", "SENWGT", "JKZONE", "JKREP", "JKINDIC", "STAFFWGT", paste0("SRWGT", 1:92)), # PIRLS, TiPi, TIMSS G4, TALIS 3S staff
      ast = c("TCHWGT", "MATWGT", "SCIWGT", "REAWGT", "JKZONE", "JKREP"), # PIRLS, TiPi, TIMSS G4
      atg = c("TCHWGT", paste0("TRWGT", 1:100)), # TALIS
      alg = c("CNTRWGT", paste0("CRWGT", 1:92)), # TALIS 3S leader

      bsa = c("TOTWGT", "HOUWGT", "SENWGT", "JKZONE", "JKREP"), # TIMSS G8
      bcg = c("TOTWGTC", paste0("CRWGT", 1:75), "JKZONEC", "JKREPC", "SCHWGT", "STOTWGTL", "STOTWGTU", "STOTWGTE", "JKCZONE", "JKCREP", paste0("SRWGT", 1:100)), # ICILS, TIMSS G8, TALIS, SITES 2006
      bsg = c("TOTWGTS", paste0("SRWGT", 1:75), "JKZONES", "JKREPS", "TOTWGT", "HOUWGT", "SENWGT", "JKZONE", "JKREP", "STAFFWGT", paste0("SRWGT", 1:92)), # ICILS, TIMSS G8, TALIS 3S staff
      btg = c("TOTWGTT", paste0("TRWGT", 1:75), "JKZONET", "JKREPT", "TCHWGT", paste0("TRWGT", 1:100)), # ICILS, TALIS
      btm = c("MTOTWGT", "JKZONE", "JKREP"), # SITES 2006
      bts = c("STOTWGT", "JKZONE", "JKREP"),
      bst = c("MATWGT", "SCIWGT", "TCHWGT", "TOTWGT", "JKZONE", "JKREP"), # TIMSS G8
      blg = c("CNTRWGT", paste0("CRWGT", 1:92)), # TALIS 3S leader

      mcg = c("SCHWGT", "STOTWGT", "STOTWGTU", "JKCZONE", "JKCREP"), # TIMSS Advanced
      msa = c("TOTWGT", "HOUWGT", "SENWGT", "JKZONE", "JKREP"), # TIMSS Advanced
      msg = c("TOTWGT", "HOUWGT", "SENWGT", "JKZONE", "JKREP"), # TIMSS Advanced
      mst = c("MATWGT", "JKZONE", "JKREP"), # TIMSS Advanced

      psa = c("TOTWGT", "HOUWGT", "SENWGT", "JKZONE", "JKREP"), # TIMSS Advanced
      psg = c("TOTWGT", "HOUWGT", "SENWGT", "JKZONE", "JKREP"), # TIMSS Advanced
      pst = c("PHYWGT", "JKZONE", "JKREP"), # TIMSS Advanced
      ccg = c("SCHWGT", paste0("SRWGT", 1:100)), # TALIS
      ctg = c("TCHWGT", paste0("TRWGT", 1:100)), # TALIS
      pcg = c("SCHWGT", "STOTWGT", "STOTWGTU", "JKCZONE", "JKCREP", paste0("SRWGT", 1:100)), # TIMSS Advanced, TALIS
      ptg = c("TCHWGT", paste0("TRWGT", 1:100)), # TALIS

      deg = c("INSWGTE", "FINWGTE", paste0("INSRWE", 1:32), paste0("FINRWE", 1:32)), # TEDS-M
      dig = c("INSWGTI", "FINWGTI", paste0("INSRWI", 1:32), paste0("FINRWI", 1:32)), # TEDS-M
      dpg = c("INSWGTP", "FINWGTP", paste0("INSRWP", 1:32), paste0("FINRWP", 1:32)), # TEDS-M
      dsg = c("INSWGTS", "FINWGTS", paste0("INSRWS", 1:32), paste0("FINRWS", 1:32)) # TEDS-M
    ),

    PV.roots = list(

      TIMSS = list( # Also preTIMSS
      ...
      PIRLS = list( # Also prePIRLS and ePIRLS
  ...
  merge.combinations <- list(
    ...
    CivED = list(
      ...
      c("bc_", "bt_", "sch.bckg.tch.bckg"), # Note that in CivED merging the school and teacher files deviates from the rest.
    ...
    # PIRLS, as well as PIRLS Literacy, ePIRLS and TiPi which have the same merging options. NOTE: The IDB Analyzer allows merging just the teacher files. This is dangerous and, thus, deprecated in RALSA.
    PIRLS = list(
      c("acg", "sch.bckg"),
      c("asg", "std.bckg"),
      c("asa", "std.ach"),
    ...
    # TALIS Startting Strong Survey (3S)
    "TALIS 3S" = list(
      c("alg", "leader.bckg"),
      c("asg", "staff.bckg"),
  ...
  Use the menu on the left to:<br/><br/>
                                         ...
                                         <ul><li>TIMSS (including TIMSS Numeracy, eTIMSS will be added with the upcoming release of TIMSS 2019)</li></ul>
  ...
  observeEvent(eventExpr = input$convertChooseSrcDir, {
    ...
    full.file.list$all.files <- list.files(path = parseDirPath(available.volumes, input$convertChooseSrcDir), full.names = FALSE, pattern = "\\.sav$|\\.txt$|\\.sps$", recursive = FALSE, ignore.case = FALSE)

    full.file.list$SAV.files <- grep(pattern = "\\.sav$", x = full.file.list$all.files, value = TRUE, ignore.case = TRUE)
  ...
  observe({
    ...
    if(length(full.file.list$SAV.files.lengths) != 0 & length(unique(full.file.list$SAV.files.lengths)) > 1) {
      ...
      options = list(
        ...
        pageLength = 5000,
        rowCallback = JS("function(r,d) {$(r).attr('height', '40px')}"),
        deferRender = TRUE, scrollY = 400, scrollX = TRUE, scroller = TRUE
      ...
      syntaxRecodeVars <- reactive({
        ...
        file.var.recode$recode.syntax <- paste0(
          ...
          if(!is.null(new.recoding.values.FAC$values) && length(initial.recode.new.values.FAC$values[new.recoding.values.FAC$values != ""]) > 0 && length(grep(pattern = "^$", x = new.recoding.labels.FAC$labels, invert = TRUE)) == length(grep(pattern = "^$", x = new.recoding.values.FAC$values, invert = TRUE))) {
            ...
            paste0(', new.labels = c("', paste(unique(new.recoding.labels.NUM$labels[new.recoding.labels.NUM$labels != ""]), collapse = '", "'), '")')
  ...
  observe({
    ...
    if(!is.null(file.pct.means$loaded) && file.pct.means$is.lsa.data == FALSE) {
      ...
      # Display the explanatory text for the panels below, also hide/show it depending on the availability of data.
  ...
  observe({
    ...
    if(!is.null(file.bench$loaded) && file.bench$is.lsa.data == FALSE) {
      ...
      observe({
        ...
        if(!is.null(benchAllVars$benchSelectedPVVars) && !is.null(benchAllVars$benchSelectedBckgVars)) {
          if(nrow(rbindlist(l = list(benchAllVars$benchSelectedBckgVars, benchAllVars$benchSelectedPVVars))) == 0 || any(benchAllVars$benchSelectedPVVars[ , Variables] %in% file.bench$PV.sets == FALSE) || any(benchAllVars$benchSelectedSplitVars[ , Variables] %in% file.bench$PV.sets == TRUE) || any(benchAllVars$benchSelectedBckgVars[ , Variables] %in% file.bench$PV.sets == TRUE) || any(benchAllVars$benchSelectedWeightVar[ , Variables] %in% all.studies.available.weights == FALSE)) {
            hide("benchValuesExpl")
            hide("benchValues")
            hide("benchValuesReset")
            hide("benchWarnMoreVars")
          } else if(nrow(rbindlist(l = list(benchAllVars$benchSelectedBckgVars, benchAllVars$benchSelectedPVVars))) > 0 || any(benchAllVars$benchSelectedPVVars[ , Variables] %in% file.bench$PV.sets == TRUE) || any(benchAllVars$benchSelectedSplitVars[ , Variables] %in% file.bench$PV.sets == FALSE) || any(benchAllVars$benchSelectedBckgVars[ , Variables] %in% file.bench$PV.sets == FALSE) || any(benchAllVars$benchSelectedWeightVar[ , Variables] %in% all.studies.available.weights == TRUE)) {
          ...
          if(is.null(file.bench$loaded) || any(benchAllVars$benchSelectedPVVars[ , Variables] %in% file.bench$PV.sets == FALSE) || any(benchAllVars$benchSelectedSplitVars[ , Variables] %in% file.bench$PV.sets == TRUE) || any(benchAllVars$benchSelectedBckgVars[ , Variables] %in% file.bench$PV.sets == TRUE) || any(benchAllVars$benchSelectedWeightVar[ , Variables] %in% all.studies.available.weights == FALSE) || nrow(rbindlist(l = list(benchAllVars$benchSelectedBckgVars, benchAllVars$benchSelectedPVVars))) == 0 || input$benchValues == "" || bench.not.numbers() == TRUE || bench.out.of.bounds() == TRUE) {
            ...
            hide("execBench")
          } else if (!is.null(file.bench$loaded) || any(benchAllVars$benchSelectedPVVars[ , Variables] %in% file.bench$PV.sets == TRUE) || any(benchAllVars$benchSelectedSplitVars[ , Variables] %in% file.bench$PV.sets == FALSE) || any(benchAllVars$benchSelectedBckgVars[ , Variables] %in% file.bench$PV.sets == FALSE) || any(benchAllVars$benchSelectedWeightVar[ , Variables] %in% all.studies.available.weights == TRUE) || nrow(rbindlist(l = list(benchAllVars$benchSelectedBckgVars, benchAllVars$benchSelectedPVVars))) > 0 || input$benchValues != "" || bench.not.numbers() == FALSE || bench.out.of.bounds() == FALSE) {
  ...
  output$helpOnRALSAWebsite <- renderText({
    HTML("Please visit the user guide section at <a href = http://ralsa.ineri.org/user-guide/, target = '_blank'> RALSA's dedicated website</a> for the userguide.")
  })
