...
study.dataset.files <- list(
  ZIP.data.folders.and.files = list(
    ...
    TIMSS_Longitudinal_2023 = list(
      "TIMSS_Longitudinal_2023_G4-5" = list("TIMSS2023L_IDB_SPSS_G4-5/2_Data Files/SPSS Data",
                                            c("acggeom8l.sav", "acgitam8l.sav", "acgjorm8l.sav", "acgkorm8l.sav", "acgmkdm8l.sav", "acgmnem8l.sav", "acgsvnm8l.sav", "acgswem8l.sav", "acgxkxm8l.sav", "asageom8l.sav", "asaitam8l.sav", "asajorm8l.sav", "asakorm8l.sav", "asamkdm8l.sav", "asamnem8l.sav", "asasvnm8l.sav", "asaswem8l.sav", "asaxkxm8l.sav", "asggeom8l.sav", "asgitam8l.sav", "asgjorm8l.sav", "asgkorm8l.sav", "asgmkdm8l.sav", "asgmnem8l.sav", "asgsvnm8l.sav", "asgswem8l.sav", "asgxkxm8l.sav", "ashgeom8l.sav", "ashitam8l.sav", "ashjorm8l.sav", "ashkorm8l.sav", "ashmkdm8l.sav", "ashmnem8l.sav", "ashsvnm8l.sav", "ashswem8l.sav", "ashxkxm8l.sav", "aspgeom8l.sav", "aspitam8l.sav", "aspjorm8l.sav", "aspkorm8l.sav", "aspmkdm8l.sav", "aspmnem8l.sav", "aspsvnm8l.sav", "aspswem8l.sav", "aspxkxm8l.sav", "asrgeom8l.sav", "asritam8l.sav", "asrjorm8l.sav", "asrkorm8l.sav", "asrmkdm8l.sav", "asrmnem8l.sav", "asrsvnm8l.sav", "asrswem8l.sav", "asrxkxm8l.sav", "astgeom8l.sav", "astitam8l.sav", "astjorm8l.sav", "astkorm8l.sav", "astmkdm8l.sav", "astmnem8l.sav", "astsvnm8l.sav", "astswem8l.sav", "astxkxm8l.sav", "atggeom8l.sav", "atgitam8l.sav", "atgjorm8l.sav", "atgkorm8l.sav", "atgmkdm8l.sav", "atgmnem8l.sav", "atgsvnm8l.sav", "atgswem8l.sav", "atgxkxm8l.sav")
      ),
      "TIMSS_Longitudinal_2023_G8-9" = list("TIMSS2023L_IDB_SPSS_G8-9/2_Data Files/SPSS Data",
                                            c("bcgjorm8l.sav", "bcgkorm8l.sav", "bcgswem8l.sav", "bsajorm8l.sav", "bsakorm8l.sav", "bsaswem8l.sav", "bsgjorm8l.sav", "bsgkorm8l.sav", "bsgswem8l.sav", "bspjorm8l.sav", "bspkorm8l.sav", "bspswem8l.sav", "bsrjorm8l.sav", "bsrkorm8l.sav", "bsrswem8l.sav", "bstjorm8l.sav", "bstkorm8l.sav", "bstswem8l.sav", "btmjorm8l.sav", "btmkorm8l.sav", "btmswem8l.sav", "btsjorm8l.sav", "btskorm8l.sav", "btsswem8l.sav")
      )
    ),
  ...
  ZIP.roots = list(
    ...
    "TIMSS Longitudinal" = list(
      "2023" = list("G4-5" = "TIMSS/TIMSS2023Longitudinal/TIMSS2023L_IDB_SPSS_G4-5.zip", "G8-9" = "TIMSS/TIMSS2023Longitudinal/TIMSS2023L_IDB_SPSS_G8-9.zip")
    ),
    "preTIMSS" = list(
...
produce.analysis.data.table <- function(data.object, object.variables, action.arguments, imported.file.attributes) {
  ...
  if(imported.file.attributes[["lsa.study"]] == "TIMSS Longitudinal") {
    data.object <- na.omit(object = data.object, cols = object.variables[["weight.var"]])
  }
  ...
  if(imported.file.attributes[["lsa.study"]] %in% c("PIRLS", "prePIRLS", "ePIRLS", "RLII", "TIMSS", "preTIMSS", "eTIMSS PSI", "TIMSS Advanced", "TIMSS Longitudinal", "TiPi")) {
...
get.analysis.and.design.vars <- function(x) {
  ...
  if(length(PV.root.passed) > 0) {
    ...
    if(isFALSE(all(unlist(passed.args[PV.root.passed]) %in% unlist(studies.all.design.variables[["PV.roots"]][[attr(x = x, which = "study")]])))) {
      stop('\nThe root PVs passed do not exist in the data for this study. All operations stop here. Check your input.', call. = FALSE)
    }
...
compute.Wald.test.all.repwgt <- function(Wald.object, vars.vector, weight.var, reps.names, keys, study.name) {
  if(study.name %in% c("TIMSS", "preTIMSS", "eTIMSS PSI", "TIMSS Advanced", "TIMSS Longitudinal", "PIRLS", "ePIRLS", "prePIRLS", "TiPi", "RLII")) {
    resamp.coef <- 0.5
  ...
  Wald.estimate <- lapply(X = Wald.object, FUN = function(i) {
    ...
    estimates <- lapply(X = cleaned.object, FUN = function(j) {
      ...
      if(study.name %in% c("TIMSS", "preTIMSS", "eTIMSS PSI", "TIMSS Advanced", "TIMSS Longitudinal", "PIRLS", "ePIRLS", "prePIRLS", "TiPi", "RLII", "CivED", "ICCS", "ICILS", "SITES", "REDS")) {
...
compute.corrected.DF <- function(rep.est.obj, output.obj, full.wgt, replicates, type) {
  DF.estimates <- lapply(X = rep.est.obj, FUN = function(i) {
    if(is.data.table(i)) {
      i <- i[!Variable %in% c("r.squared", "adj.r.squared")]
      i <- split(x = i, by = key(i), drop = TRUE)
      i <- lapply(X = i, FUN = function(j) {
        tmp.keys <- key(j)
        j[ , (replicates) := lapply(.SD, function(k) {
          k - get(full.wgt)
        }), .SDcols = replicates, by = tmp.keys]
        j[ , (full.wgt) := NULL]
        j <- melt(data = j, id.vars = tmp.keys)
        j[ , variable := NULL]
        j[ , value := value^2]
        j <- j[!is.na(value), ]
        j <- data.table(unique(j[ , mget(tmp.keys)]), DF = sum(j[ , value])^2 / sum(j[ , value^2]))
        setkeyv(x = j, cols = tmp.keys)
      })
      tmp.keys <- key(i[[1]])
      i <- rbindlist(l = i)
      setkeyv(x = i, cols = tmp.keys)
      if(type == "JR") {
        i[ , DF := (3.16 - (2.77/sqrt(length(replicates)))) * DF]
      }
      return(i)
    } else {
      N.PVs <- length(i)
      tmp.keys <- unlist(unique(lapply(X = i, FUN = function(j) {
        key(j)
      })))
      i <- lapply(X = i, FUN = function(j) {
        j <- j[!Variable %in% c("r.squared", "adj.r.squared")]
        j <- split(x = j, by = c(tmp.keys, "Variable"), drop = TRUE)
        j <- lapply(X = j, FUN = function(k) {
          if(length(grep(pattern = "^V[[:digit:]]+", x = colnames(k), value = TRUE)) > 0) {
            setnames(x = k, old = grep(pattern = "^V[[:digit:]]+", x = colnames(k), value = TRUE), new = c(full.wgt, replicates))
          }
          k[ , (replicates) := lapply(.SD, function(l) {
            l - get(full.wgt)
          }), .SDcols = replicates, keyby = tmp.keys]
          k[ , (full.wgt) := NULL]
          k <- melt(data = k, id.vars = tmp.keys)
          k[ , variable := NULL]
          k[ , value := value^2]
          k <- k[!is.na(value), ]
        })
      ...
      i <- rbindlist(l = i)
      i <- split(x = i, by = c(tmp.keys, "Variable"), drop = TRUE)
      i <- lapply(X = i, FUN = function(j) {
        data.table(unique(j[ , mget(tmp.keys)]), DF = (1/N.PVs) * (sum(j[ , value])^2 / sum(j[ , value^2])))
      })
      i <- rbindlist(l = i)
      setkeyv(x = i, cols = tmp.keys)
      if(type == "JR") {
        i[ , DF := (3.16 - (2.77/sqrt((length(replicates) * N.PVs) / N.PVs))) * DF]
      } else {
        i
      }
      return(i)
...
reshape.list.statistics.bckg <- function(estimate.object, estimate.name, bckg.vars.vector, weighting.variable, data.key.variables, new.names.vector, replication.weights, study.name, SE.design, multiply.columns = 1) {
  ...
  lapply(X = estimate.object, function(i) {
    ...
    if(study.name %in% c("PIRLS", "prePIRLS", "ePIRLS", "RLII", "TIMSS", "preTIMSS", "eTIMSS PSI", "TIMSS Advanced", "TIMSS Longitudinal", "TiPi") && SE.design == FALSE) {
      i[ , paste0("_SE") := sqrt(0.5*sum.of.squares)]
    } else if(study.name %in% c("PIRLS", "prePIRLS", "ePIRLS", "RLII", "TIMSS", "preTIMSS", "eTIMSS PSI", "TIMSS Advanced", "TIMSS Longitudinal", "TiPi") && SE.design == TRUE || study.name %in% c("CivED", "ICCS", "ICILS", "SITES", "REDS")) {
...
aggregate.PV.estimates <- function(estimate.object, estimate.name, root.PV, PV.vars.vector, data.key.variables, study.name, SE.design) {
  object.type <- deparse(substitute(estimate.object))
  if(study.name %in% c("PIRLS", "prePIRLS", "ePIRLS", "RLII", "TIMSS", "preTIMSS", "eTIMSS PSI", "TIMSS Advanced", "TIMSS Longitudinal", "TiPi") && SE.design == FALSE || study.name %in% c("ICCS", "ICILS")) {
    lapply(X = estimate.object, FUN = function(i) {
  ...
  } else if(study.name %in% c("PIRLS", "prePIRLS", "ePIRLS", "RLII", "TIMSS", "preTIMSS", "eTIMSS PSI", "TIMSS Advanced", "TIMSS Longitudinal", "TiPi") && SE.design == TRUE || study.name %in% c("CivED", "SITES")) {
    lapply(X = estimate.object, FUN = function(i) {
  ...
  lapply(X = estimate.object, FUN = function(i) {
    ...
    if(study.name %in% c("PIRLS", "prePIRLS", "ePIRLS", "RLII", "TIMSS", "preTIMSS", "eTIMSS PSI", "TIMSS Longitudinal", "TIMSS Advanced", "TiPi")) {
...
compute.table.average <- function(output.obj, object.variables, data.key.variables, data.properties) {
  all.estimate.columns <- grep(pattern = "^Percentages$|Percentages_.*|Mean_.*|Median_.*|MAD_.*|Mode_.*|Prctl_.*|Variance_.*|SD_.*|Correlation_|Coefficients|Odds_|Wald_|t_value|Estimate|Crosstab_", x = names(output.obj), value = TRUE)
  ...
  if(length(PV.estimate.root) != 0) {
    if(any(!PV.estimate.root %in% c("PV.root.dep", "PV.root.indep"))) {
      ...
      PV.estimate.columns <- grep(pattern = "^Coefficients|^Estimate|t_value", x = all.estimate.columns, value = TRUE)
      non.PV.estimate.columns <- grep(pattern = "^Coefficients|^Estimate|t_value", x = all.estimate.columns, value = TRUE, invert = TRUE)
    }
  } else {
...
produce.analysis.info <- function(data, cnt.ID, study, cycle, weight.variable, rep.design, used.shortcut, number.of.reps, in.time) {
  tmp <- data.table(COUNTRY = cnt.ID,
                    ...
                    DESIGN = rep.design,
                    if(!missing(used.shortcut) && study %in% c("PIRLS", "prePIRLS", "ePIRLS", "RLII", "TIMSS", "preTIMSS", "eTIMSS PSI", "TIMSS Advanced", "TIMSS Longitudinal", "TiPi")) {
...
export.results <- function(output.object, analysis.type, add.graphs = FALSE, perc.graphs = NULL, non.perc.graphs = NULL, simple.desc.graphs = NULL, unwgt.miss.pattern.graphs = NULL, wgt.miss.pattern.graphs = NULL, unwgt.flux.graphs = NULL, wgt.flux.graphs = NULL, analysis.info.obj, model.stats.obj, Rao.Scott.adj.chi.sq.obj, destination.file, warns.list, open.exported.file) {
  ...
  if(analysis.type %in% c("lsa.pcts.means", "lsa.prctls", "lsa.bench", "lsa.corr", "lsa.lin.reg", "lsa.bin.log.reg", "lsa.crosstabs")) {
    ...
    addStyle(wb = export.workbook, sheet = "Weighted V-correlations", style = two.decimals.style, cols = grep(pattern = "^Correlation_|^t_|^DF_", x = colnames(output.object[["V_Correlations_Wgt"]])), rows = 2:(nrow(output.object[["V_Correlations_Wgt"]]) + 1), gridExpand = TRUE)
    ...
    addStyle(wb = export.workbook, sheet = "Weighted U-correlations", style = two.decimals.style, cols = grep(pattern = "^Correlation_|^t_|^DF_", x = colnames(output.object[["U_Correlations_Wgt"]])), rows = 2:(nrow(output.object[["U_Correlations_Wgt"]]) + 1), gridExpand = TRUE)
    ...
    addStyle(wb = export.workbook, sheet = "Weighted VU-correlations", style = two.decimals.style, cols = grep(pattern = "^Correlation_|^t_|^DF_", x = colnames(output.object[["VU_Max_Weighted"]])), rows = 2:(nrow(output.object[["VU_Max_Weighted"]]) + 1), gridExpand = TRUE)
